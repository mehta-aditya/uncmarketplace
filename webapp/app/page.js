...
export default function Home() {
  return (
    <>
      <main className="flex flex-col items-center justify-center min-h-screen homeblue">
        ...
        <h2 className="text-lg mb-8">
          Click <Link href="/signup" className="text-blue-500 underline">here</Link> to SIGN UP!
        </h2>
